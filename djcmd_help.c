...
void draw_help_view(void)
{
	static const char *lines[] = {
		...
		"   Library Autoplay : Continuous Mix Mode \u2014 alternates Deck A/B, auto-loads",
		"                      and crossfades when a track reaches its final 8 bars.",
		"                      Toggle with Ctrl+A or in ESC \u2192 SYNC tab.",
		...
		"",
		" USB",
		"   Ctrl+U        Export selected local crate to USB",
		"                 \u2192 Must be in Crates panel with cursor on a local (non-USB) crate name",
		"                 \u2192 One USB found: export begins immediately",
		"                 \u2192 Multiple USBs: picker appears (j/k to choose, ENTER confirm, ESC cancel)",
		"                 \u2192 Crate already on USB from another machine: rename prompt (ESC to cancel)",
		"                 Audio + sidecars copied; unchanged files (size+mtime match) are skipped",
		"   Ctrl+U \u00d73      Rescan for USB devices  (works from any panel \u2014 press 3 times in a row)",
		"   Ctrl+E        Eject USB  (Crates panel, cursor on USB group header \u2014 prompts Y/n)",
		"",
		" OPTIONS OVERLAY",
		"   ESC           Open / Close Options menu (or Close Help)",
		"   LEFT / RIGHT  Switch between tabs (INFO \u00b7 AUDIO \u00b7 DISPLAY \u00b7 WAVE \u00b7 SYNC \u00b7 THEME \u00b7 MIDI \u00b7 OUT \u00b7 FX)",
		"   j / k         Navigate rows within a tab",
		"   - / +         Adjust settings or toggle options",
		"   MIDI Tab      Learn and bind your controller (L=learn, S=save)",
		"",
		" SYSTEM",
		"   TAB           Cycle bottom panel (Browser \u2192 Playlist \u2192 Library \u2192 Crates \u2192 Sampler)",
